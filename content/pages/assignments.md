...
| 2 | Principle of stationary action |  {{< br >}}{{< br >}} Assignment 1 (due in Ses #5): exercises 1.2, 1.3, 1.4, 1.5 {{< br >}}{{< br >}} Begin the Double Pendulum Project, [exercise 1.39 (PDF)](http://web.mit.edu/dvp/www/Work/6.946/dvp-pendulum-paper.pdf), which will be due in Ses #13. {{< br >}}{{< br >}}  |
| 3 | Lagrange equations | &nbsp; |
| 4 | Hamilton's principle | &nbsp; |
| 5 | Coordinate transformations and rigid constraints |  {{< br >}}{{< br >}} Assignment 2 (due in Ses #8): exercises 1.8, 1.9 by hand, 1.11, 1.21 {{< br >}}{{< br >}} Remember to show all steps on 1.9 and 1.11. {{< br >}}{{< br >}}  |
| 6 | Total-time derivatives and the Euler-Lagrange operator | &nbsp; |
| 7 | State and evolution: chaos | &nbsp; |
| 8 | Conserved quantities |  {{< br >}}{{< br >}} Assignment 3 (due in Ses #10): exercises 1.26, 1.27, 1.29 {{< br >}}{{< br >}} On 1.29, use the constraint formalism. {{< br >}}{{< br >}} Remember that the project on the double pendulum, exercise 1.39, is due in Ses #13. {{< br >}}{{< br >}}  |
...
| 11 | Motion of a free rigid body |  {{< br >}}{{< br >}} Assignment 5 (due in Ses #16): exercises 2.11, 2.12, 2.13 {{< br >}}{{< br >}} Begin project on the rotation of Mercury, exercise 2.21, which will be due in Ses #21. {{< br >}}{{< br >}}  |
| 12 | Axisymmetric top | &nbsp; |
| 13 | Spin-orbit coupling | &nbsp; |
| {{< td-colspan 3 >}}**Hamiltonian mechanics**{{< /td-colspan >}} |||
| 14 | Hamilton's equations | &nbsp; |
| 15 | Legendre transformation, Hamiltonian actian |  {{< br >}}{{< br >}} Choose one of the following two projects. These projects are quite a bit of work, so the problem sets for the next few weeks are small. {{< br >}}{{< br >}} [Exercise 3.14 (PDF)](http://web.mit.edu/dvp/www/Work/6.946/dvp-hamilton-paper.pdf): The Periodically-Driven Pendulum {{< br >}}{{< br >}} Exercise 3.15: Spin-orbit Surfaces of Section {{< br >}}{{< br >}} Your write-up of one of these is due in Ses #29. {{< br >}}{{< br >}}  |
